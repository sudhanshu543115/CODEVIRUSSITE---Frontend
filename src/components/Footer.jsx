...
//import  from "../assets/img/footer-bg.jpg";
...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    services: [
      { name: 'Application Security', href: '#services' },
      { name: 'DDOS Cyber Protection', href: '#services' },
      { name: 'Data Network Security', href: '#services' },
      { name: 'Cloud-native Security', href: '#services' },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-6">
              <img src={logo} alt="" className="w-50 h-28" />
            </Link>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} CodeVirusSecurity. All Right Reserved. Design By CamionThemes
            </p>
